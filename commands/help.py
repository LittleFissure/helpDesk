...
HELP_ENTRIES = {
    ...
    "/color set": {"summary": "Set your personal role colour using a hex code.", "usage": "/color set <hex_code>", "details": "Creates your personal role if it does not exist yet, then updates its colour."},
    ...
    "/color rename": {"summary": "Rename your personal role.", "usage": "/color rename <new_name>", "details": "Lets you rename only your tracked personal role in the current server."},
    ...
    "/room create": {"summary": "Create your public personal room in the configured category.", "usage": "/room create", "details": "Creates one tracked room for you in the current server."},
    "/room rename": {"summary": "Rename your personal room.", "usage": "/room rename <new_name>", "details": "Only renames the room tracked as yours in the current server."},
    ...
    "/setup show": {"summary": "Show this server's stored bot configuration.", "usage": "/setup show", "details": "Administrator-only. Displays the stored room category, archive category, and staff role."},
